...
/**
 * GitHub OAuth sign-in / sign-up button.
 * Clean, professional styling with subtle border.
 */
export default function GitHubButton({ label = 'Continue with GitHub', onClick }) {
  return (
    <motion.button
      type="button"
